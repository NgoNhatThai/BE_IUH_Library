...
var connectNoSql = require('../config');
var Background = require('../models/background.model');
connectNoSql();
// Dữ liệu mẫu bạn muốn thêm
var sampleBackgrounds = [{
...
function seedBackgrounds() {
  return _seedBackgrounds.apply(this, arguments);
} // Gọi hàm seedBackgrounds để thêm dữ liệu
function _seedBackgrounds() {
  _seedBackgrounds = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var createdBackgrounds;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return Background.deleteMany();
        case 3:
          _context.next = 5;
          return Background.insertMany(sampleBackgrounds);
        case 5:
          createdBackgrounds = _context.sent;
        ...
        case 9:
          ...
          console.error('Error seeding backgrounds:', _context.t0);
        case 12:
          _context.prev = 12;
