...
var _user = _interopRequireDefault(require("./src/services/user.service"));
...
_app["default"].set("port", process.env.PORT || 7777);
var server = _app["default"].listen(_app["default"].get("port"), function () {
  console.log("Express running \u2192 PORT ".concat(server.address().port).rainbow);
});
...
io.on("connection", function (socket) {
  socket.on("setup", function (data) {
    socket.join((data === null || data === void 0 ? void 0 : data.id) || data);
  ...
  socket.on("send-add-friend", function (data) {
    console.log("send-add-friend", data === null || data === void 0 ? void 0 : data.id);
    socket["in"](data === null || data === void 0 ? void 0 : data.id).emit("need-accept-addFriend", data);
  });
  ...
  socket.on("finish-typing", function (room) {
    socket["in"](room).emit("finish-typing", room);
  });
  socket.on("send-reaction", function (data) {
  ...
  socket.on("online", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
      var res, friendShips, friends;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _user["default"].findFriendsLimit(data, -1);
          case 2:
            res = _context.sent;
            if (res.errCode === 0) {
  ...
  socket.on("new-chat", function (data) {
    var participants = data.participants.map(function (participant) {
  ...
  socket.on("offline", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _user["default"].updateOnline(data, new Date());
          case 2:
            _context2.next = 4;
            return _user["default"].findFriendsLimit(data, -1);
          case 4:
  ...
  socket.on("transfer-disband-group", function (data) {
    socket["in"](data._id).emit("transfer-disband-group", data);
  });
  socket.on("open-call", function (data) {
  ...
  socket.on("add-member", function (data) {
    if (data !== null && data !== void 0 && data.participants) {
  ...
  socket.on("pin-message", function (room) {
    socket["in"](room).emit("pin-message", room);
  });
  socket.on("dissolutionGroupChat", function (data) {
